...
<body>
    ...
    <section>
        ...
        c10.03-5.8,16.27-16.6,16.27-28.19C698.28,528.74,692.04,517.94,682.01,512.14z M529.83,610.19V470.47l121,69.86L529.83,610.19z" />
                ...
                <input class="input_100 form-control" type="text" placeholder="Apellido" name="apellido" value=""
                    required>
                <input class="input_100 form-control" type="email" placeholder="Correo" name="correo" value="" required>
                <input class="input_100 form-control" type="password" placeholder="Contraseña" name="contrasena"
                    value="" required>
                <input class="input_100 btn btn-outline btn-amarillo btn-block" type="submit" value="Registrarse"
                    name="ingresar_panel_user" value="">
                <a href="login.php"><b>* Inicia sesión si ya tienes una cuenta</a>

                <?php if (isset($_SESSION['message_email_deney'])) {?>
                <div class="alert alert-<?= $_SESSION['message_email_deney_type'];?> alert-dismissible fade show"
                    role="alert">
                ...
                <div class="alert alert-<?= $_SESSION['message_pass_deney_type'];?> alert-dismissible fade show"
                    role="alert">
