    ...
    <section>
      ...
      <div class="contenedor">
          ...
          <form class="register" action="validar_login.php" method="POST">
            ...
            <input class="input_100 form-control" type="text" placeholder="Nombre" name="nombre" value="">
            <input class="input_100 form-control" type="text" placeholder="Apellido" name="apellido" value="">
            <input class="input_100 form-control" type="email" placeholder="Correo" name="correo" value="">
            <input class="input_100 form-control" type="password" placeholder="Contraseña" name="contrasena" value="">
            <input class="input_100 btn btn-outline-success btn-block"type="submit" value="Ingresar" name="ingresar_panel_user" value="">
