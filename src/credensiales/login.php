...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <form class="login" action="login_panel.php" method="POST">
      ...
      <img class="logo" src="https://i.ibb.co/LzRysXY/Recurso-1.png" width="30" height="30"  alt="">
      <h1 class="title">Welcome a to Commi_video</h1>
      <?php
      ...
      <?php session_unset(); } ?>
        ...
        <input class="input_100 btn btn-success btn-block" type="submit" value="Ingresar" name="ingresar_panel_user" value="">
