...
<body>
    ...
    <form class="login" action="login_panel.php" method="POST">
        <section class="svg">
            ...
            <svg version="1.1" id="LG1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  c10.03-5.8,16.27-16.6,16.27-28.19C698.28,528.74,692.04,517.94,682.01,512.14z M529.83,610.19V470.47l121,69.86L529.83,610.19z" />
      ...
      if (isset($_SESSION['error_message_login'])) {?>
        ...
        <?php session_unset(); } ?>
        <input class="input_100 form-control" type="email" placeholder="Correo electrónico" name="correo" value=""
            required>
        <input class="input_100 form-control" type="password" placeholder="Contraseña" name="contrasena" value=""
            required>
        <input class="input_100 btn btn_amarillo btn-block" type="submit" value="Ingresar" name="ingresar_panel_user"
            value="">
