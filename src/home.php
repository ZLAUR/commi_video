...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand title" href="#">
            <img src="https://i.ibb.co/gPK5xQK/LG1.png" width="30" height="30" class="d-inline-block align-top" alt=""
                loading="lazy">
            Commi Video
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="option/upload_video.php"> Subir</a>
                </li>
                <li class="nav-item active">
    ...
    <section class="info_user">
        <h1 class="info_user_title">Bienvenido <span
                class="nick_user"><?php echo $_SESSION['user_email_session']?></span> </h1>
    ...
    while ($row = mysqli_fetch_array($consult)) { ?>
        <div class="box">
            <a href="asset/list_video.php?id=<?php echo $row['id']?>">
                <video class="miniature_video" muted width="300" height="300"
